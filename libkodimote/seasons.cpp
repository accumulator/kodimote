...
Seasons::Seasons(int tvshowid, KodiModel *parent):
    KodiLibrary(parent),
    m_tvshowid(tvshowid),
    m_refreshing(false)
{
...
void Seasons::receivedAnnouncement(const QVariantMap &map)
{
    ...
    KodiConnection::sendCommand("VideoLibrary.GetSeasons", params, this, "playcountReceived");
    m_refreshing = true;
}
...
void Seasons::refresh()
{
    ...
    KodiConnection::sendCommand("VideoLibrary.GetSeasons", params, this, "listReceived");
    m_refreshing = true;
}
...
KodiModel *Seasons::enterItem(int index)
{
...
void Seasons::fetchItemDetails(int index)
{
    ...
    int id = KodiConnection::sendCommand("VideoLibrary.GetSeasonDetails", params, this, "seasonDetailsReceived");
